...
CGO_ENABLED=0 go build -ldflags "-s -w -X github.com/libatomic/mailpit/config.Version=${VERSION}" -o /mailpit
...
LABEL org.opencontainers.image.title="Mailpit" \
  ...
  org.opencontainers.image.source="https://github.com/libatomic/mailpit" \
